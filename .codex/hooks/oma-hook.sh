...
__oma_bin=""
if [ -x "/var/folders/8m/3kv6lzt13yj_wkxg7mxtzw180000gn/T/bunx-501-oh-my-agent@latest/node_modules/.bin/oh-my-agent" ]; then
  __oma_bin="/var/folders/8m/3kv6lzt13yj_wkxg7mxtzw180000gn/T/bunx-501-oh-my-agent@latest/node_modules/.bin/oh-my-agent"
