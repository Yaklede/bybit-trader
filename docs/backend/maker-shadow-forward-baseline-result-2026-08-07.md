...
고정한 raw snapshot을 queue stress `1.0/1.5/2.0배`와 비용 stress `1.0/1.5/2.0배`의 9개 조합으로 재생했다. 비용 stress는 maker·taker 수수료와 taker 종료 슬리피지에 함께 적용했다.

| Queue 배수 | 종료 거래 | 비용 전 손익(1배 비용) | 순손익 1배 | 순손익 1.5배 | 순손익 2배 |
|---:|---:|---:|---:|---:|---:|
| 1.0 | 13 | -0.19390861 | -0.56051217 | -0.75996025 | -0.95940301 |
| 1.5 | 12 | -0.15555880 | -0.51168726 | -0.71397156 | -0.91624964 |
| 2.0 | 11 | -0.14276878 | -0.49485532 | -0.69027765 | -0.88569642 |

모든 값은 USDT다. 보수적 queue 가정에서 체결 수와 손실이 함께 줄었지만 비용 전 손익이 양수로 전환된 경우는 없었다. matrix fingerprint는 `251ad157058aba0ea13c96f783e6628e55f785c442651fc3d18e2c4d23c05b81`이며, 9개 시나리오 모두 같은 source snapshot을 사용했다.
