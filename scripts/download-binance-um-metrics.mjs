...
import { downloadBinanceUmMetricsArchives } from "./lib/binance-um-metrics-archive.mjs";

const args = parseArgs(process.argv.slice(2));
const symbol = args.symbol ?? "BTCUSDT";
const startAt = args.start ?? "2021-01-01T00:00:00Z";
const endAt = args.end ?? "2024-01-01T00:00:00Z";
const outDir = args.out ?? "build/research/binance-um-metrics";

const archives = await downloadBinanceUmMetricsArchives({
  symbol,
  startAt,
  endAt,
  outDir,
