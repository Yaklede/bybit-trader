...
data class VolumeConfirmedTrendLiveRiskPolicy(
    val maximumDailyLossFraction: BigDecimal? = null,
    val maximumAccountDrawdownFraction: BigDecimal = BigDecimal("0.35"),
    val maximumConsecutiveLosses: Int? = null,
    ...
    init {
        require(
            ...
            "Trend live maximum daily loss fraction must be disabled or in (0, 1]."
        }
        ...
        require(maximumConsecutiveLosses == null || maximumConsecutiveLosses in 1..100) {
            "Trend live maximum consecutive losses must be disabled or between 1 and 100."
        }
