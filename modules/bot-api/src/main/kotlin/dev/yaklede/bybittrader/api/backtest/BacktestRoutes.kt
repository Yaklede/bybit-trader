                ...
                backtestService.run(
                    ...
                    config =
                        BacktestConfig(
                            ...
                            exitSlippageRate = request.exitSlippageRate ?: request.slippageRate,
                            ...
                            fixedTargetEnabled = request.fixedTargetEnabled,
                            maxHoldCandles = request.maxHoldCandles,
                            maxTradesPerUtcDay = request.maxTradesPerUtcDay,
                            minimumEntryRiskFraction = request.minimumEntryRiskFraction,
                            maximumEntryRiskFraction = request.maximumEntryRiskFraction,
                        ),
                )
...
data class BacktestRunRequest(
    ...
    fun validated(): BacktestRunRequest {
        ...
        BacktestConfig(
            ...
            exitSlippageRate = exitSlippageRate ?: slippageRate,
            ...
            maximumEntryRiskFraction = maximumEntryRiskFraction,
        )
        return this
    }
}
        ...
        trades =
            trades.takeLast(20).map { trade ->
                BacktestTradeResponse(
                    ...
                    initialStopPrice = trade.initialStopPrice.roundForApi(),
                    targetPrice = trade.targetPrice?.roundForApi(),
                    exitTriggerPrice = trade.exitTriggerPrice.roundForApi(),
                    ...
                    equityAfter = trade.equityAfter.roundForApi(),
