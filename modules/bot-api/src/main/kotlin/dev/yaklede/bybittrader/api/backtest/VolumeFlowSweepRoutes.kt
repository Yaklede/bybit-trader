...
data class VolumeFlowSweepRequest(
    ...
    fun toSweepConfig(): VolumeFlowSweepConfig =
        VolumeFlowSweepConfig(
            ...
            minDirectionalCloseStrengthValues = minDirectionalCloseStrengthValues,
            ...
            minEntryRiskPctValues = minEntryRiskPctValues,
            maxEntryRiskPctValues = maxEntryRiskPctValues,
            ...
            minActiveDayCoveragePct = minActiveDayCoveragePct,
...
private fun VolumeFlowSweepCandidate.toResponse(): VolumeFlowSweepCandidateResponse =
    VolumeFlowSweepCandidateResponse(
        ...
        minDirectionalCloseStrength = minDirectionalCloseStrength.roundForApi(),
        minRejectionWickRatio = minRejectionWickRatio.roundForApi(),
        entryLookaheadM1Candles = entryLookaheadM1Candles,
        minEntryRiskPct = minEntryRiskPct?.roundForApi(),
        maxEntryRiskPct = maxEntryRiskPct?.roundForApi(),
