...
curl -X POST \
  -H "Authorization: Bearer $BOT_CONTROL_TOKEN" \
  -H "Content-Type: application/json" \
  --data '{"symbol":"BTCUSDT","m1Limit":525600,"m5Limit":105120,"m15Limit":35040,"riskFraction":0.0075,"setupMode":"BREAKOUT_CONTINUATION","entryMode":"RETEST_CONFIRMATION","sideMode":"BOTH","setupTimeframe":"M5","relativeVolumeThreshold":5.0,"volumeZScoreThreshold":1.5,"requireM5Vwap":false,"requireContextVwap":true,"requireContextTrend":true,"allowedMarketRegimes":["TREND_UP","TREND_DOWN","RANGE"],"requireRegimeSideAlignment":true,"requireKeyLevelProximity":true,"keyLevelTolerancePct":0.0025,"avoidRangeMiddle":true,"maxEstimatedFeeR":0.2,"targetR":1.2,"exitMode":"FIXED_TARGET","breakevenTriggerR":null,"maxHoldM1Candles":30,"dailyTargetPct":null,"dailyStopPct":1.0,"minTradesPerDay":1,"maxTradesPerDay":5}' \
  http://127.0.0.1:8080/backtests/volume-flow/run
curl -X POST \
  -H "Authorization: Bearer $BOT_CONTROL_TOKEN" \
  -H "Content-Type: application/json" \
  --data '{"symbol":"BTCUSDT","m1Limit":525600,"m5Limit":105120,"m15Limit":35040,"riskFractionValues":[0.0075],"setupModes":["BREAKOUT_CONTINUATION","FAILED_BREAK_REVERSAL"],"entryModes":["RETEST_CONFIRMATION"],"sideModes":["BOTH"],"setupTimeframes":["M5"],"relativeVolumeThresholdValues":[5.0],"volumeZScoreThresholdValues":[1.5],"setupRangeLookbackValues":[12],"requireM5VwapValues":[false],"requireContextVwapValues":[true],"requireContextTrendValues":[true],"allowedMarketRegimeValues":[["TREND_UP","TREND_DOWN","RANGE"],["TREND_DOWN"]],"requireRegimeSideAlignmentValues":[false,true],"requireKeyLevelProximityValues":[false,true],"avoidRangeMiddleValues":[false,true],"targetRValues":[1.2],"exitModes":["FIXED_TARGET","RUNNER"],"runnerTrailActivationRValues":[1.0],"runnerTrailDistanceRValues":[0.5],"breakevenTriggerRValues":[null,1.0],"maxHoldM1CandlesValues":[15,30,60,120],"dailyTargetPct":null,"maxCandidates":1000,"topResults":10}' \
